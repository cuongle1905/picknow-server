...
INSERT INTO `company` VALUES (1,'CoopMart',NULL,NULL,NULL,NULL,'abcd'),(2,'FamilyMart',NULL,NULL,NULL,NULL,NULL),(3,'CircleK',NULL,NULL,NULL,NULL,NULL),(4,'MiniStop',NULL,NULL,NULL,NULL,NULL);
...
CREATE TABLE `store` (
  ...
  CONSTRAINT `fk_company` FOREIGN KEY (`company`) REFERENCES `company` (`id`) ON UPDATE CASCADE,
  CONSTRAINT `fk_ward` FOREIGN KEY (`ward`) REFERENCES `ward` (`id`) ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2021-09-23  1:49:58
